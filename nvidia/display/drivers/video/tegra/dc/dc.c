...
/* Power Management APIs to support PM domains */
static int tegra_dc_suspend_pd(struct device *dev);
static int tegra_dc_resume_pd(struct device *dev);
...
static const struct dev_pm_ops tegra_dc_pm_ops = {
	SET_SYSTEM_SLEEP_PM_OPS(tegra_dc_suspend_pd, tegra_dc_resume_pd)
};
