...
BOOL    E9EF2EDB9981445B99EF3AAC11BF7248_EX( F42A18AF66EFF459eA332CA253FFF8A65 * pDevice, BYTE nIndex, ULONG bBytes, BYTE * pValue );
...
BYTE GetVerticalFreq( F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, WORD *Vreq  );
...
//#define Switch_HDMIRX_Bank(x) HDMIRX_WriteI2C_Byte( p_Device, REG_RX_F7F93DF8A9ECE49c1884C75ADC18648B7, (x)&1)
...
//    #define HDMIRX_OUTPUT_TYPE 0
    #define HDMIRX_OUTPUT_TYPE 0x10 //externel sync
#else
//    #define HDMIRX_OUTPUT_TYPE 0
...
BYTE 
Get_IT6603_Initialization_Status(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
	#ifdef AME_SA7160
	...
	MZ0380_SYS_CFG * p_sys_cfg = (MZ0380_SYS_CFG *)(p_Device->m_pCustomSystemConfigProperty);
	
	#endif

	#if defined(AME_PL330B) || defined(AME_PL330A)
	
	PL330B_SYS_CFG * p_sys_cfg = (PL330B_SYS_CFG *)(p_Device->m_pCustomSystemConfigProperty);
...
void
Check_HDMInterrupt(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
	Interrupt_Handler(p_Device) ;
}

BYTE HDMIRX_ReadI2C_Byte(F42A18AF66EFF459eA332CA253FFF8A65 * pDevice, BYTE RegAddr)
{
	BYTE F7DCDC607F3644b1591980748EA26F4D8 = 0;

	if(pDevice)
	{
		#ifdef AME_SA7160
		F7DCDC607F3644b1591980748EA26F4D8 = E9EF2EDB9981445B99EF3AAC11BF7248( pDevice, RegAddr );
		#endif

		#ifdef AME_FH8735
		F7DCDC607F3644b1591980748EA26F4D8 = d836abc2d864435a9642168ecb38d9d1( pDevice, RegAddr );
		#endif

		#ifdef AME_MZ0380
		F7DCDC607F3644b1591980748EA26F4D8 = MZ0380_GetITE6603Register( pDevice, RegAddr );
		#endif

		#if defined(AME_PL330B) || defined(AME_PL330A)
		F7DCDC607F3644b1591980748EA26F4D8 = FD553E100FEF42A09291CAE5868EE78F( pDevice, RegAddr );
		#endif
	}

	return F7DCDC607F3644b1591980748EA26F4D8;
}


BOOL HDMIRX_WriteI2C_Byte(F42A18AF66EFF459eA332CA253FFF8A65 * pDevice, BYTE RegAddr,BYTE d)
{
	BOOL flag = 0;
	...
	{
		#ifdef AME_SA7160
		flag = CB37B62CB1B5419F925F88107F66A9DE( pDevice, RegAddr, d );
		#endif

		#ifdef AME_FH8735
		flag = b3feca2851a644ada8021e7f3a60a61d( pDevice, RegAddr, d );
		#endif

		#ifdef AME_MZ0380
		flag = MZ0380_SetITE6603Register( pDevice, RegAddr, d );
		#endif

		#if defined(AME_PL330B) || defined(AME_PL330A)
		flag = FC8E5418A20E4E708DA4529778160F9B( pDevice, RegAddr, d );
		#endif
	}
...
BOOL HDMIRX_ReadI2C_ByteN(F42A18AF66EFF459eA332CA253FFF8A65 * pDevice, BYTE RegAddr,BYTE *pData,int N)
{
	BOOL flag = 0;
	...
	{
		#ifdef AME_SA7160
		flag = E9EF2EDB9981445B99EF3AAC11BF7248_EX( pDevice, RegAddr, N, pData );
		#endif

		#ifdef AME_FH8735
		flag = d836abc2d864435a9642168ecb38d9d1_EX( pDevice, RegAddr, N, pData );
		#endif

		#ifdef AME_MZ0380
		flag = MZ0380_GetITE6603Register_EX( pDevice, RegAddr, N, pData );
		#endif

		#if defined(AME_PL330B) || defined(AME_PL330A)
		flag = D81BC288B4DA4C9F969C93D4AFA639EA( pDevice, RegAddr, N, pData );
		#endif
	}
	return flag;
}

BOOL HDMIRX_WriteI2C_ByteN(F42A18AF66EFF459eA332CA253FFF8A65 * pDevice, BYTE RegAddr,BYTE *pData,int N)
{
	BOOL flag = 0;
	...
	{
		#ifdef AME_SA7160
		flag = CB37B62CB1B5419F925F88107F66A9DE_EX( pDevice, RegAddr, N, pData );
		#endif

		#ifdef AME_FH8735
		flag = b3feca2851a644ada8021e7f3a60a61d_EX( pDevice, RegAddr, N, pData );
		#endif

		#ifdef AME_MZ0380
		flag = MZ0380_SetITE6603Register_EX( pDevice, RegAddr, N, pData );
		#endif

		#if defined(AME_PL330B) || defined(AME_PL330A)
		flag = FFD1BB8E56E243D3AC39C9882F27BD4F( pDevice, RegAddr, N, pData );
		#endif
	}
	return flag;
}
void Switch_HDMIRX_Bank(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE x)
{
	HDMIRX_WriteI2C_Byte(p_Device, 0x0f,(x)&1);
}
void SetHWMuteClrMode(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
	{ SetHWMuteCTRL(p_Device, (~B_HW_AUDMUTE_CLR_MODE),(B_HW_AUDMUTE_CLR_MODE)) ;}
}	
void SetHWMuteClr(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
	{ SetHWMuteCTRL(p_Device, (~B_HW_MUTE_CLR),(B_HW_MUTE_CLR)) ; }
}
void ClearHWMuteClr(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
	{ SetHWMuteCTRL(p_Device, (~B_HW_MUTE_CLR),0) ; }
}
void SetALLMute(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
...
BOOL
CheckHDMIRX(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
...
void
SelectHDMIPort(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE ucPort)
{
	#ifdef AME_SA7160
    ...
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SelectHDMIPort ucPort = %d, ucCurrentHDMIPort = %d\n",ucPort, p_sys_cfg->o_input_ite6603.ucCurrentHDMIPort);

}

BYTE
GetCurrentHDMIPort(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
	#ifdef AME_SA7160
...
void
InitCAT6023(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "InitCAT6023()\n");
...
///////////////////////////////////////////////////////////////////////////
    ...
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "InitCAT6023(): reg07 = %02X, ucCurrentHDMIPort = %d\n", (int)HDMIRX_ReadI2C_Byte(p_Device, 07), (int)p_sys_cfg->o_input_ite6603.ucCurrentHDMIPort);
...
void PowerDownHDMI(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "PowerDownHDMI()\n");
...
BOOL IsCAT6023Interlace(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "IsCAT6023Interlace()\n");
...
WORD getCAT6023HorzTotal(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    BYTE uc[2] ;
	WORD hTotal ;
	...
	//F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023HorzTotal() hTotal(%d)\n", hTotal);

	return hTotal ;
}

WORD getCAT6023HorzActive(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023HorzActive()\n");
    BYTE uc[3] ;
...
WORD getCAT6023HorzFrontPorch(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023HorzFrontPorch()\n");
...
WORD getCAT6023HorzSyncWidth(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023HorzSyncWidth()\n");
...
WORD getCAT6023HorzBackPorch(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023HorzBackPorch()\n");
...
WORD getCAT6023VertTotal(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    BYTE uc[3] ;
	WORD vTotal, vActive ;
	...
	//F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023VertTotal() vTotal(%d)\n", vTotal);

	return vTotal ;
}

WORD getCAT6023VertActive(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023VertActive()\n");
...
WORD getCAT6023VertFrontPorch(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023VertFrontPorch()\n");
...
WORD getCAT6023VertSyncToDE(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023VertSyncToDE()\n");
    WORD vSync2DE ;
...
WORD getCAT6023VertSyncWidth(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023VertSyncWidth()\n");
    WORD vSync2DE ;
...
WORD getCAT6023VertSyncBackPorch(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023VertSyncBackPorch()\n");
    WORD vBackPorch ;
...
BYTE getCAT6023xCnt(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023xCnt()\n");
    return HDMIRX_ReadI2C_Byte( p_Device, REG_RX_VID_XTALCNT_128PEL) ;
}

BOOL getCAT6023AudioInfo(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE *pbAudioSampleFreq, BYTE *pbValidCh)
{
//    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023AudioInfo()\n");
...
BOOL
GetAVIInfoFrame(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE *pData)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "GetAVIInfoFrame()\n");
...
BOOL
GetAudioInfoFrame(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE *pData)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "GetAudioInfoFrame()\n");
...
BOOL
GetMPEGInfoFrame(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE *pData)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "GetMPEGInfoFrame()\n");
...
BOOL
GetVENDORSPECInfoFrame(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE *pData)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "GetVENDORSPECInfoFrame()\n");
...
BOOL
GetACPPacket(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE *pData)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "GetACPPacket()\n");
...
void
getCAT6023Regs(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE *pData)
{
    int i, j ;
...
BYTE
getCAT6023OutputColorMode(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023OutputColorMode()\n");
	#ifdef AME_SA7160
...
BYTE
getCAT6023OutputColorDepth(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023OutputColorDepth()\n");
    BYTE uc ;
...
void
Terminator_Off(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    BYTE uc ;
    uc = HDMIRX_ReadI2C_Byte( p_Device, REG_RX_PWD_CTRL1) | (B_PWD_AFEALL|B_PWDC_ETC);
    HDMIRX_WriteI2C_Byte( p_Device, REG_RX_PWD_CTRL1, uc ) ;
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Terminator_Off, reg07 = %02x\n",(int)uc);
}

void
Terminator_On(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    BYTE uc ;
    uc = HDMIRX_ReadI2C_Byte( p_Device, REG_RX_PWD_CTRL1) & ~(B_PWD_AFEALL|B_PWDC_ETC);
    HDMIRX_WriteI2C_Byte( p_Device, REG_RX_PWD_CTRL1, uc) ;
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Terminator_On, reg07 = %02x\n",(int)uc);
}

void
Terminator_Reset(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Terminator_Reset()\n");
...
void
RDROM_Reset(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    BYTE i ;
    BYTE uc ;

    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "RDROM_Reset()\n");
...
void
Check_RDROM(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    BYTE uc ;
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Check_HDCP_RDROM()\n");
    ...
    if( IsSCDT(p_Device) )
    {
...

        {
            ...
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Check_HDCP_RDROM() done.\n");
            return ;
        }
    }
}
...
void
SWReset_HDMIRX(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SWReset_HDMIRX()\n");
...
void
LoadCustomizeDefaultSetting(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "LoadCustomizeDefaultSetting()\n");
	#ifdef AME_SA7160
...
#ifdef AME_FH8735 
	{
        HDMIRX_WriteI2C_Byte( p_Device, REG_RX_VCLK_CTRL, 0x30 ) ;
	}
#endif
	
#if defined(AME_PL330B) || defined(AME_PL330A) 
	{
        HDMIRX_WriteI2C_Byte( p_Device, REG_RX_VCLK_CTRL, 0x20 ) ;

        HDMIRX_WriteI2C_Byte( p_Device, REG_RX_MISC_CTRL, 0x17 ) ;

		HDMIRX_WriteI2C_Byte( p_Device, REG_RX_VIDEO_MAP, 0x60 ) ;
	}
#endif
    /*
...
void
SetDefaultRegisterValue(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetDefaultRegisterValue()\n");
    BYTE i ;
...
void
ClearIntFlags(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE flag)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "ClearIntFlags()\n");
    BYTE uc ;
...
void
ClearHDCPIntFlags(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "ClearHDCPIntFlags()\n");
    BYTE uc ;
...
BOOL
IsSCDT(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
//    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "IsSCDT()\n");
    BYTE uc ;
...
BOOL
CheckPlg5VPwr(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
//    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "CheckPlg5VPwr()\n");
	#ifdef AME_SA7160
...
void
SetMUTE(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE AndMask, BYTE OrMask)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetMUTE()\n");
    BYTE uc ;
...
void
SetIntMask1(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE AndMask,BYTE OrMask)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetIntMask1()\n");
    BYTE uc ;
    if( AndMask != 0 )
    {
...
void
SetIntMask2(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE AndMask,BYTE OrMask)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetIntMask2()\n");
    BYTE uc ;
    if( AndMask != 0 )
    {
...
void
SetIntMask3(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE AndMask,BYTE OrMask)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetIntMask3()\n");
    BYTE uc ;
    if( AndMask != 0 )
    {
...
void
SetIntMask4(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE AndMask,BYTE OrMask)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetIntMask4()\n");
    BYTE uc ;
    if( AndMask != 0 )
    {
...
#if 0
void
SetGeneralPktType(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE type)
{
...
BOOL
IsCAT6023HDMIMode(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
//    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "IsCAT6023HDMIMode()\n");
    BYTE uc ;
    uc = HDMIRX_ReadI2C_Byte( p_Device, REG_RX_SYS_STATE) ;
...
void
Interrupt_Handler(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
	#ifdef AME_SA7160
...
//PETER [2011.03.14]
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "[%d]Interrupt_Handler() VState(0d%d) Resolution(0x%x) FrameRate(%d)\n", p_Device->F0C7DF8CDF1004a6eB97071CBDF459ECE, p_sys_cfg->o_input_ite6603.VState, p_Device->m_nCustomAnalogVideoResolutionProperty, p_Device->m_nCustomAnalogVideoFrameRateProperty );
...
//fix lock status
    ...
    int1data = HDMIRX_ReadI2C_Byte( p_Device, REG_RX_INTERRUPT1) ;
 	...
 	if( int1data & B_SCDTOFF )// no video sync stable, "Video stable is off" interrupt on
	{
	     F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "[%02d] force to videomute, sys_state(%x) int1data(%x) int4data(%x)\n", p_Device->F0C7DF8CDF1004a6eB97071CBDF459ECE, sys_state, int1data, int4data);
 	
		//SetALLMute();//should be no interupt to SA7160 ever since
    ...
    {
        //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "system state = %02X\n",(int)sys_state);
		//F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Interrupt 1 = %02X\n",(int)int1data);
        //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Interrupt 4 = %02X\n",(int)int4data);
        ...
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "5V Power Off interrupt\n");
        ...
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SCDT Off interrupt\n");
            RXINT_SCDT_Off(p_Device) ;
        }

        if( int1data & B_PWR5VON )
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "5V Power On interrupt\n");
            RXINT_5V_PwrOn(p_Device) ;
        }

        if( int1data & B_VIDMODE_CHG )
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Video mode change interrupt.\n:");
        ...
        {
           // F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "HDMI Mode change interrupt.\n");
            RXINT_HDMIMode_Chg(p_Device) ;
        }

        if( int1data & B_SCDTON )
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SCDT On interrupt\n");
			if((sys_state & 0x4) == 0)
				RXINT_VideoMode_Chg(p_Device);
			else
        ...
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "RXCKON DET interrupt\n");
    ...
    if( int2data )
    {
        ...
        //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Interrupt 2 = %02X\n",(int)int2data);
        ClearIntFlags(p_Device, B_CLR_PKT_INT|B_CLR_MUTECLR_INT|B_CLR_MUTESET_INT) ;

        if( int2data & B_PKT_SET_MUTE )
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "AVMute set interrupt.\n" );
            RXINT_AVMute_Set(p_Device) ;
        }

        if( int2data & B_NEW_AVI_PKG )
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "New AVI Info Frame Change interrupt\n");
            RXINT_SetNewAVIInfo(p_Device) ;
        }

        if( ( int2data & B_PKT_CLR_MUTE ))
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "AVMute clear interrupt.\n" );
    ...
    if( int3data &(B_R_AUTH_DONE|B_R_AUTH_START))
    {
        ...
        if( p_sys_cfg->o_input_ite6603.bHDCPMode & HDCP_REPEATER )
        {
	        ...
	        {
	            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, " B_R_AUTH_START\n");
	            SwitchRxHDCPState(RXHDCP_AuthStart) ;
	        }
	        if( int3data & B_R_AUTH_DONE )
	        {
	            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "B_R_AUTH_DONE \n");
	...
	if( p_sys_cfg->o_input_ite6603.VState == VSTATE_VideoOn || p_sys_cfg->o_input_ite6603.VState == VSTATE_HDCP_Reset)
	{
	    ...
	    if( int3data &(B_ECCERR|B_AUDFIFOERR|B_AUTOAUDMUTE) )
	    {
	        ...
	        {
		        //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Interrupt 3 = %02X\n",(int)int3data);
		        if( int3data & (B_AUTOAUDMUTE|B_AUDFIFOERR))
		        {
		            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Audio Error interupt\n");
	        ...
	        {
	            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "ECC error interrupt\n");
	...
	//
	{
		if( p_sys_cfg->o_input_ite6603.VState == VSTATE_VideoOn )
		{
            ...
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "HDCP_status(0x%x)\n", HDCP_status);
    ...
    if( int1data | int2data )
    {
		...
		F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "[%02d] %02X %02X %02X %02X\n",  p_Device->F0C7DF8CDF1004a6eB97071CBDF459ECE,
            (int)int1data,
            (int)int2data,
            (int)int3data,
            (int)sys_state) ;
...
void
RXINT_5V_PwrOn(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "RXINT_5V_PwrOn()\n");
	#ifdef AME_SA7160
...
void
RXINT_5V_PwrOff(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "RXINT_5V_PwrOff()\n");
    BYTE sys_state ;
...
void
RXINT_SCDT_On(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "RXINT_SCDT_On()\n");
	#ifdef AME_SA7160
...
void CDR_Reset(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    BYTE uc;
	//F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "CDR_Reset()\n");
	#ifdef AME_SA7160
...
void
RXINT_SCDT_Off(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "RXINT_SCDT_Off()\n");
	#ifdef AME_SA7160
    ...
    if( p_sys_cfg->o_input_ite6603.VState != VSTATE_PwrOff )
    {
        //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "GetSCDT OFF\n");
        SwitchVideoState(p_Device, VSTATE_SyncWait) ;
...
void
RXINT_VideoMode_Chg(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "RXINT_VideoMode_Chg()\n");
    BYTE sys_state ;
...
void
RXINT_HDMIMode_Chg(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "RXINT_HDMIMode_Chg()\n");
	#ifdef AME_SA7160
	...
	if(p_sys_cfg->o_input_ite6603.VState == VSTATE_VideoOn )
    {
        if( IsCAT6023HDMIMode(p_Device) )
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "HDMI Mode.\n");
            SwitchAudioState(p_Device, ASTATE_RequestAudio) ;

        }
        else
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "DVI Mode.\n");
...
void RXINT_RXCKON(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "RXINT_RXCKON()\n");
	#ifdef AME_SA7160
...
void
RXINT_AVMute_Set(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "RXINT_AVMute_Set()\n");
	BYTE uc ;
	#ifdef AME_SA7160
...
void
RXINT_AVMute_Clear(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "RXINT_AVMute_Clear()\n");
	BYTE uc ;
	#ifdef AME_SA7160
...
void
RXINT_SetNewAVIInfo(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "RXINT_SetNewAVIInfo()\n");
	#ifdef AME_SA7160
...
void
RXINT_ResetAudio(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "RXINT_ResetAudio()\n");
	#ifdef AME_SA7160
...
void
RXINT_ResetHDCP(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "RXINT_ResetHDCP()\n");
	BYTE uc ;
	#ifdef AME_SA7160
...
void
Timer_Handler(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
//    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Timer_Handler() reg0x11(0x%x)\n", HDMIRX_ReadI2C_Byte( p_Device, 0x11));
...
void
VideoTimerHandler(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
	UCHAR uc ;
	#ifdef AME_SA7160
...
//		F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "VideoTimerHandler() VSTATE_SWReset p_sys_cfg->o_input_ite6603.VideoCountingTimer(0d%d)\n", p_sys_cfg->o_input_ite6603.VideoCountingTimer);
	...
	if( p_sys_cfg->o_input_ite6603.VState == VSTATE_PwrOff )
	{
//		F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "VideoTimerHandler() VSTATE_PwrOff \n");
	...
	if( p_sys_cfg->o_input_ite6603.VState == VSTATE_SyncWait)
	{
		//F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "VideoTimerHandler() VSTATE_SyncWait \n");
    ...
    if( p_sys_cfg->o_input_ite6603.VState == VSTATE_SyncWait )
    {
        ...
        if( p_sys_cfg->o_input_ite6603.VideoCountingTimer == 0 )
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "VsyncWaitResetTimer up, call SWReset_HDMIRX()\n",p_sys_cfg->o_input_ite6603.VideoCountingTimer);
            SWReset_HDMIRX(p_Device) ;
            return ;
        ...
        else
        {
			...
			uc=HDMIRX_ReadI2C_Byte( p_Device, REG_RX_SYS_STATE);
		    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "REG_RX_SYS_STATE = %X\r",(int)uc);
			...
			else
			{
				...
				if(uc == (B_RXCK_VALID|B_VCLK_DET))
				{
					if(p_sys_cfg->o_input_ite6603.ucDVISCDToffCNT++>100)
					{
							...
							delay1ms(1);
							HDMIRX_WriteI2C_Byte( p_Device, REG_RX_RST_CTRL, 0);
							//F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "rst_ctrl (2)= %X \n\n",(int)HDMIRX_ReadI2C_Byte( p_Device, REG_RX_RST_CTRL));
			...
			//F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "VideoTimerHandler() VSTATE_SyncWait p_sys_cfg->o_input_ite6603.VideoCountingTimer(0d%d)\n", p_sys_cfg->o_input_ite6603.VideoCountingTimer);
    ...
    if( p_sys_cfg->o_input_ite6603.VState == VSTATE_SyncChecking )
    {
        ...
        {
			//F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "VideoTimerHandler() VSTATE_SyncChecking p_sys_cfg->o_input_ite6603.VideoCountingTimer(0d%d)\n", p_sys_cfg->o_input_ite6603.VideoCountingTimer);
    ...
    if( p_sys_cfg->o_input_ite6603.VState == VSTATE_HDCP_Reset )
    {
        ...
        if( --p_sys_cfg->o_input_ite6603.VideoCountingTimer == 0)
        {
        	///F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "HDCP timer reach, reset !!\n");
        ...
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "VideoTimerHandler[VSTATE_HDCP_Reset](%d)\n",p_sys_cfg->o_input_ite6603.VideoCountingTimer);
            do {
	        	ClearIntFlags(p_Device, B_CLR_ECC_INT) ;
	        	delay1ms(1) ;
	        	uc = HDMIRX_ReadI2C_Byte( p_Device, REG_RX_INTERRUPT3) ;
    ...
    if( p_sys_cfg->o_input_ite6603.VState == VSTATE_VideoOn )
    {
		...
		{
			bVidModeChange = TRUE ;
			//F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "HTotal changed.\n");
		}
		...
		if(!bVidModeChange)
		{
			...
			if( xCnt > 0x80 )
			{
				if( ABS(diff) > 6 )
				{
					//F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Xcnt changed. %02x -> %02x ",(int)xCnt,(int)p_sys_cfg->o_input_ite6603.currXcnt);
					//F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "diff = %d\r\n",(int)diff);
					bVidModeChange = TRUE ;
				}
			}
			else if ( xCnt > 0x40 )
        ...
        if(p_sys_cfg->o_input_ite6603.s_CurrentVM.VActive < 300)
        {
    		if( !bVidModeChange )
    		{
    			...
    			{
    				//F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "ScanMode change.\r\n");
    				bVidModeChange = TRUE ;
    			}
    		}
        }
...
void
SetupAudio(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
//    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetupAudio()\n");
	BYTE uc ;
    BYTE RxAudioCtrl ;
	#ifdef AME_SA7160
        ...
        else
        {
            ...
            if(p_sys_cfg->o_input_ite6603.ucHDMIAudioErrorCount > 10)
            {
                ...
                else
                {
                    ...
                    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "===[Audio FS Error ]===\n");
                    RxAudioCtrl |=B_FORCE_FS;
                }
    ...
    else
    {
        ...
        uc &= ~B_CTSINI_EN;
        HDMIRX_WriteI2C_Byte( p_Device, REG_RX_MCLK_CTRL, uc) ;
//        F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Audio Off, clear Audio Error Count.\n");
    }
}

void
EnableAudio(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "EnableAudio()\n");
	#ifdef AME_SA7160
...
void AudioTimerHandler(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
//    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "AudioTimerHandler()\n");
	BYTE uc;
    ...
    case ASTATE_AudioOn:
           ...
           || p_sys_cfg->o_input_ite6603.AudioCaps.SampleFreq != CurAudioCaps.SampleFreq */ )
        {
            ...
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Audio change, clear Audio Error Count.\n");
		...
		if ( p_sys_cfg->o_input_ite6603.AudioCountingTimer != 0 )
        {
            ...
            {
                p_sys_cfg->o_input_ite6603.ucHDMIAudioErrorCount=0 ;
    			//F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Audio On, clear Audio Error Count.\n");
            }
        }
...
BYTE    CAT6023FsGet(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "CAT6023FsGet()\n");
    BYTE RxFS ;
    RxFS=HDMIRX_ReadI2C_Byte( p_Device, REG_RX_FS) & 0x0F;
    return    RxFS;
}

BOOL    CAT6023HDAudioGet(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "CAT6023HDAudioGet()\n");
    BOOL bRxHBR ;
    bRxHBR=(HDMIRX_ReadI2C_Byte( p_Device, REG_RX_AUDIO_CH_STAT)&(1<<6))?TRUE:FALSE;
    return    bRxHBR;
}

BOOL    CAT6023MultiPCM(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "CAT6023MultiPCM()\n");
    BOOL bRxMultiCh ;
    bRxMultiCh=(HDMIRX_ReadI2C_Byte( p_Device, REG_RX_AUDIO_CH_STAT) & (1<<4))?TRUE:FALSE;
    return    bRxMultiCh;
}

BYTE    CAT6023AudioChannelNum(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "CAT6023AudioChannelNum()\n");
    BYTE RxChEn ;
...
void    CAT6023HBRMclkSet(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE cFs)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "CAT6023HBRMclkSet()\n");
    BYTE    uc;
    uc=HDMIRX_ReadI2C_Byte( p_Device, REG_RX_MCLK_CTRL) & 0xF8;
...
void getCAT6023InputAudio(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, AUDIO_CAPS *pAudioCaps)
{
//    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023InputAudio()\n");
    BYTE uc ;
	#ifdef AME_SA7160
...
//add audio sampling freq
	{	
		...
		//F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023InputAudio() bAudioSampleFreq(0d%d) bValidCh(0d%d) ret(0d%d)\n", bAudioSampleFreq, bValidCh, ret);
		...
		if( ret )
		{
			...
			if( 0 ) { //pDevice->m_nCustomPreviewAudioSampleFrequencyProperty[ 0 ] > 0 ) {

				//p_sys_cfg->n_input_audio_sampling_frequency = p_Device->m_nCustomPreviewAudioSampleFrequencyProperty[ 0 ];
			}
			else {
		...
		p_Device->m_nCustomAnalogAudioSampleFrequencyProperty = p_sys_cfg->n_input_audio_sampling_frequency;
		...
		if( p_sys_cfg->o_input_ite6603.previous_audio_sampling_freq != p_sys_cfg->n_input_audio_sampling_frequency ) {
			...
			if( p_Device->iManufacturer == 0x8A ) {
...
void getCAT6023InputChStat(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, AUDIO_CAPS *pAudioCaps)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023InputChStat()\n");
    BYTE uc ;
...
void
MuteProcessTimerHandler(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
//    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "MuteProcessTimerHandler()\n");
    BYTE uc ;
    ...
    if( p_sys_cfg->o_input_ite6603.MuteByPKG == ON )
    {
        ...
        if( (p_sys_cfg->o_input_ite6603.MuteResumingTimer > 0)&&(p_sys_cfg->o_input_ite6603.AState == ASTATE_AudioOn))
        {
            ...
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "p_sys_cfg->o_input_ite6603.MuteResumingTimer = %d uc = %02X\n",p_sys_cfg->o_input_ite6603.MuteResumingTimer , (int)uc);
...
void
AssignVideoTimerTimeout(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, USHORT TimeOut)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "AssignVideoTimerTimeout() TimeOut(%d)\n", TimeOut);
	#ifdef AME_SA7160
...
void
AssignAudioTimerTimeout(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, USHORT TimeOut)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "AssignAudioTimerTimeout()\n");
	#ifdef AME_SA7160
...
#if 0
void
ResetVideoTimerTimeout(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
	#ifdef AME_SA7160
...
void
ResetAudioTimerTimeout(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
	#ifdef AME_SA7160
...
void
SwitchVideoState(F42A18AF66EFF459eA332CA253FFF8A65 * pDevice, Video_State_Type state)
{
//    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SwitchVideoState() p_sys_cfg->o_input_ite6603.VState(%s)\n",VStateStr[state]);
	#ifdef AME_SA7160
    ...
    case VSTATE_VideoOn:
        ...
        else
        {
            ...
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "[%s:%d] reg%02X = %02X\n",__FILE__,__LINE__,(int)REG_RX_AUDIO_CTRL, (int)uc);
...
void
SwitchAudioState(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, Audio_State_Type state)
{
	#ifdef AME_SA7160
    ...
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "p_sys_cfg->o_input_ite6603.AState -> %s\n",AStateStr[p_sys_cfg->o_input_ite6603.AState]);
    ...
    case ASTATE_AudioOn:
        ...
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "AudioOn, but still in mute.\n");
...
//1001
//1920*1200
const unsigned int AudioFrequencyMatch[16] = {
		441, 0, 480, 320, 0,      0, 0,      0, 		//0 - 7
		882, 0, 960, 0,     1764, 0, 1920, 0,	//8 - 15
	};
const unsigned int CEA861DotClock2[]={13500, 13513, 25175, 25200, 27000, 27027, 74175, 74250, 148351, 148500};

void
DumpSyncInfo(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, VTiming *pVTiming)
{
	ULONG VFreq ;
...
//peter [2011.03.14] enbale debug message
	F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "HActive %4d,",pVTiming->HActive);
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "VActive %4d,",pVTiming->VActive);
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "HTotal %4d,",pVTiming->HTotal);
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "VTotal %4d,",pVTiming->VTotal);
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "PCLK %8ld,",pVTiming->PCLK);
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "xCnt 0x%02x,",pVTiming->xCnt);
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "HFrontPorch %3d,",pVTiming->HFrontPorch);
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "HSyncWidth %3d,",pVTiming->HSyncWidth);
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "HBackPorch %3d,",pVTiming->HBackPorch);
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "VFrontPorch %2d,",pVTiming->VFrontPorch);
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "VSyncWidth %2d,",pVTiming->VSyncWidth);
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "VBackPorch %2d,",pVTiming->VBackPorch);
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "%s,",pVTiming->ScanMode?"PROG":"INTERLACE");
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "%s,",pVTiming->VPolarity?"Vpos":"Vneg");
    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "%s,",pVTiming->HPolarity?"Hpos":"Hneg");

    VFreq = pVTiming->PCLK ;
//1920*1200
	if(pVTiming->HActive == 1920 && pVTiming->VActive == 1200)
	{
		unsigned int audion, audiocts, audiocd_fs, i, dotclock;
		unsigned char colordepth, temp;
		//use the pixel clock as the audio PLL reference
		temp = HDMIRX_ReadI2C_Byte(p_Device, 0x78);
		if(temp & 0xc0)
		{
			temp = temp&0x7;
			temp |= 8;
			HDMIRX_WriteI2C_Byte(p_Device, 0x78, temp);
			delay1ms(200);		//delay until next AUDIO CTS
		}

		temp = HDMIRX_ReadI2C_Byte(p_Device, 0x81);
		audion = HDMIRX_ReadI2C_Byte(p_Device, 0x7f);
		audion |= (HDMIRX_ReadI2C_Byte(p_Device, 0x80)<<8);
		audion |= ((temp&0xf)<<16);
		audiocts = HDMIRX_ReadI2C_Byte(p_Device, 0x82);
		audiocts |= (HDMIRX_ReadI2C_Byte(p_Device, 0x83)<<8);
		audiocts = (audiocts<<4)|((temp&0xf0)>>4);

		temp = HDMIRX_ReadI2C_Byte(p_Device, 0x84);		
		colordepth = temp>>4;		//0 or 4 = 24 bit, 5 = 30 bits, 6 = 36 bits, 7 = 48 bits
		temp = temp&0xf;		//
		audiocd_fs = AudioFrequencyMatch[temp];
		if(audiocd_fs == 0 || audion == 0)
			return;

		//dotclock = (unsigned int)(((LONGLONG)128*(LONGLONG)(audiocts*audiocd_fs))/(audion*10));		//unit = KHz

		LONGLONG temp_clock = 128 * audiocts * audiocd_fs;

		do_div(temp_clock, audion*10);

		dotclock = temp_clock;
	
		F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO,"dotclock %8ld,",dotclock);

		VFreq = dotclock;
		//restore
		HDMIRX_WriteI2C_Byte(p_Device, 0x78, 0xC1);
  ...
  //  VFreq /= pVTiming->VTotal ;
	...
	VFreq += ((pVTiming->HTotal * pVTiming->VTotal)/2);

	VFreq /= (pVTiming->HTotal * pVTiming->VTotal);
	
	F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO,"VFreq %d\n",VFreq );
...
//dempa
	...
	if( p_sys_cfg->n_input_video_resolution_cx == 1366 ) {

		p_sys_cfg->n_input_video_resolution_cx = 1368;
	}
	F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "n_input_video_resolution_cx(%d) n_input_video_resolution_cy(%d) n_input_video_resolution_fps(%d)\n", p_sys_cfg->n_input_video_resolution_cx, p_sys_cfg->n_input_video_resolution_cy,p_sys_cfg->n_input_video_resolution_fps );

	F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "b_input_video_resolution_spliter_mode(%d) n_input_video_resolution_h_total (%d)\n", p_sys_cfg->b_input_video_resolution_spliter_mode, p_sys_cfg->n_input_video_resolution_h_total );

	if( p_sys_cfg->b_input_video_signal_changed )
	{
		#ifndef AME_PL330A
		if( p_Device->iManufacturer == 0x18 ||

		   (p_Device->iManufacturer == 0x1A &&

			p_Device->m_nCustomGpioSupportProperty == 8) ) {
				...
				((p_sys_cfg->n_input_video_resolution_cx == 1280) && (p_sys_cfg->n_input_video_resolution_cy == 720) && ( p_sys_cfg->n_input_video_resolution_fps == 30)) 	)
			{
				...
				uc = HDMIRX_ReadI2C_Byte( p_Device, REG_RX_PG_CTRL1) ;

				uc |= 0x04;//by pass
				
				HDMIRX_WriteI2C_Byte( p_Device, REG_RX_PG_CTRL1, uc) ;

				FB416CF1CDE54D39BFB1E336A29493C2( p_Device, 0x25, 0x01 );
			}
			else
			{
				BYTE uc = 0;
				...
				FB416CF1CDE54D39BFB1E336A29493C2( p_Device, 0x25, 0x00 );
			}
		}
		   ...
		   (p_Device->iManufacturer == 0x1A &&
			...
			if( (p_sys_cfg->n_input_video_resolution_cx == 1920 && p_sys_cfg->n_input_video_resolution_cy == 1080 && p_sys_cfg->n_input_video_resolution_fps >= 50) ||
				...
				if( p_sys_cfg->n_input_video_resolution_cy == 1200 ) {
					...
					FB416CF1CDE54D39BFB1E336A29493C2( p_Device, 0x24, 0x01 );
				}
				else {

					FB416CF1CDE54D39BFB1E336A29493C2( p_Device, 0x24, 0x00 );
				}
				ULONG R0000E004 = A77C4935F8134B048348571A43F2A9CA( p_Device, 0x0000E000 + 0x0004 ); // GPIO.WR
									
				R0000E004 |=  0x00000004;

				A60D06861EDC409FA66867980ABA9748( p_Device, 0x0000E000 + 0x0004, R0000E004 );
	...
	{	if( p_sys_cfg->n_input_video_resolution_fps > 50 ) {
			...
			p_Device->FD314ADAD9404496b842EBFC396E875CB = V4L2_STD_NTSC_M;
		}
		else if( p_sys_cfg->n_input_video_resolution_fps > 30 ) {

			p_Device->FD314ADAD9404496b842EBFC396E875CB = V4L2_STD_PAL_B;
		}
		...
		p_Device->m_nCustomAnalogVideoResolutionProperty = (p_sys_cfg->n_input_video_resolution_cx << 16) | 

														  (p_sys_cfg->n_input_video_resolution_cy <<  0);

		p_Device->m_nCustomAnalogVideoFrameRateProperty = (p_sys_cfg->n_input_video_resolution_fps);
		
		p_Device->m_nCustomAnalogVideoInterleavedProperty = (p_sys_cfg->n_input_video_resolution_interleaved);
		...
		{	BYTE bAudioSampleFreq = 0;
			...
			F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "DumpSyncInfo() bAudioSampleFreq(0d%d) bValidCh(0d%d) ret(0d%d)\n", bAudioSampleFreq, bValidCh, ret);
...
BOOL
CheckSignalStable( F42A18AF66EFF459eA332CA253FFF8A65 * pDevice)
{
    BYTE uc1, uc2, uc3 ;
	VTiming					s_TempVM;  
	long diff ;
	...
	F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "CheckSignalStable() \n" );
	...
	for( index = 0; index < 20; index++ )
	{
		...
		{
			F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "CheckSignalStable() s_TempVM.HActive(%d) s_CurrentVM.HActive(%d)\n", s_TempVM.HActive, p_sys_cfg->o_input_ite6603.s_CurrentVM.HActive  );
		...
		if( ABS(diff) > 4 )
		{
			F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "CheckSignalStable() s_TempVM.HTotal(%d) s_CurrentVM.HTotal(%d)\n", s_TempVM.HTotal, p_sys_cfg->o_input_ite6603.s_CurrentVM.HTotal  );
		...
		if( ABS(diff) > 10 )
		{
			F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "CheckSignalStable() s_TempVM.VActive(%d) s_CurrentVM.VActive(%d)\n", s_TempVM.VActive, p_sys_cfg->o_input_ite6603.s_CurrentVM.VActive  );
			return FALSE;
		}
...
*/
	    F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "CheckSignalStable() success(%d)\n", index );
		//fix replug
		if(index >= 9)
		{
			//peter add
			if((s_TempVM.HActive <= 1920) && (s_TempVM.VActive <= 1200))
			{
				return TRUE;
			}
			else
			{
			    F1838C0176E054c129B7F2BF440D1236E( KERN_INFO, "[%02d] over range() HActive(%d) VActive(%d) ????????????\n", pDevice->F0C7DF8CDF1004a6eB97071CBDF459ECE,  s_TempVM.HActive, s_TempVM.VActive );
...
BOOL
bGetSyncInfo(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "bGetSyncInfo()\n");
    long diff ;
    ...
    {
        //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "p_sys_cfg->o_input_ite6603.s_CurrentVM.xCnt == %02x\n",p_sys_cfg->o_input_ite6603.s_CurrentVM.xCnt);
        p_sys_cfg->o_input_ite6603.s_CurrentVM.PCLK = 1234 ;
        /*
        for( i = 0x58 ; i < 0x66 ; i++ )
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "HDMIRX_ReadI2C_Byte(%02x) = %02X\n",i,(int)HDMIRX_ReadI2C_Byte(p_Device, i)));
        }
        */
        return FALSE ;
    }

	p_sys_cfg->n_input_video_resolution_fps_m = (GetITE6604_1001(p_Device, p_sys_cfg->o_input_ite6603.s_CurrentVM.PCLK, p_sys_cfg->o_input_ite6603.s_CurrentVM.VTotal, p_sys_cfg->o_input_ite6603.s_CurrentVM.HTotal) == 1) ? 1 : 0;
...
void
Video_Handler(F42A18AF66EFF459eA332CA253FFF8A65 * pDevice)
{
    ...
    {
        //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Video_Handler, p_sys_cfg->o_input_ite6603.VState = VSTATE_ModeDetecting.\n");

        ClearIntFlags(pDevice, B_CLR_MODE_INT) ;

        if(!bGetSyncInfo(pDevice))
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Current Get: "); //DumpSyncInfo(pDevice, &p_sys_cfg->o_input_ite6603.s_CurrentVM) ;

            SwitchVideoState(pDevice, VSTATE_SyncWait) ;
            p_sys_cfg->o_input_ite6603.bGetSyncFailCount ++ ;
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "bGetSyncInfo() fail, p_sys_cfg->o_input_ite6603.bGetSyncFailCount = %d ", p_sys_cfg->o_input_ite6603.bGetSyncFailCount);
            if( p_sys_cfg->o_input_ite6603.bGetSyncFailCount % 32 == 31 )
            {
                //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, " called SWReset\n");
                SWReset_HDMIRX(pDevice) ;
            }
            else if( p_sys_cfg->o_input_ite6603.bGetSyncFailCount % 8 == 7)
            {
                //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, " reset video.\n");
        ...
        else
        {
            ...
            F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Matched Result: "); DumpSyncInfo(pDevice, &p_sys_cfg->o_input_ite6603.s_CurrentVM) ;
            p_sys_cfg->o_input_ite6603.bGetSyncFailCount = 0 ;
        }
        ...
        if(!bHDMIMode)
        {
            ...
            F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "This is DVI Mode.\n");
            p_sys_cfg->o_input_ite6603.NewAVIInfoFrameF = FALSE ;
        }
...
void
SetVideoInputFormatWithoutInfoFrame(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE bInMode)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetVideoInputFormatWithoutInfoFrame()\n");
    BYTE uc ;
	#ifdef AME_SA7160
...
//peter	2010.12.20	
        ...
        break ;
    default:
        //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Invalid Color mode %d, ignore.\n", bInMode);
        return ;
    }
...
void
SetColorimetryByMode(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device/*PSYNC_INFO pSyncInfo*/)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetColorimetryByMode()\n");
	#ifdef AME_SA7160
...
void
SetVideoInputFormatWithInfoFrame(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetVideoInputFormatWithInfoFrame()\n");
	#ifdef AME_SA7160
    ...
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "REG_RX_AVI_DB1 %02X get uc %02X ",(int)REG_RX_AVI_DB1,(int)uc);
    ...
    case B_AVI_COLOR_YUV444:
        F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "input YUV444 mode ");
        p_sys_cfg->o_input_ite6603.bInputVideoMode |= F_MODE_YUV444 ;
        break ;
    case B_AVI_COLOR_YUV422:
        F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "input YUV422 mode ");
        p_sys_cfg->o_input_ite6603.bInputVideoMode |= F_MODE_YUV422 ;
        break ;
    case B_AVI_COLOR_RGB24:
        F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "input RGB24 mode ");
        p_sys_cfg->o_input_ite6603.bInputVideoMode |= F_MODE_RGB24 ;
//peter	2010.12.20	
		p_sys_cfg->o_input_ite6603.bInputVideoMode |= F_MODE_0_255;
        break ;
    default:
        F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Invalid input color mode, ignore.\n");
        return ;
    }

    if( (p_sys_cfg->o_input_ite6603.bInputVideoMode & F_MODE_CLRMOD_MASK)!=(bOldInputVideoMode & F_MODE_CLRMOD_MASK))
    {
        F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "Input Video mode changed.");
    }
...
BOOL
SetColorimetryByInfoFrame(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    BYTE uc ;
	#ifdef AME_SA7160
    ...
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetColorimetryByInfoFrame: p_sys_cfg->o_input_ite6603.NewAVIInfoFrameF = %s ",p_sys_cfg->o_input_ite6603.NewAVIInfoFrameF?"TRUE":"FALSE");
    ...
    if(p_sys_cfg->o_input_ite6603.NewAVIInfoFrameF)
    {
        ...
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "F_MODE_ITU601\n");
            p_sys_cfg->o_input_ite6603.bInputVideoMode &= ~F_MODE_ITU709 ;
            return TRUE ;
        }
        else if(uc == (B_AVI_CLRMET_ITU709<<O_AVI_CLRMET))
        {
            //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "F_MODE_ITU709\n");
            p_sys_cfg->o_input_ite6603.bInputVideoMode |= F_MODE_ITU709 ;
            return TRUE ;
        }
...
void
SetColorSpaceConvert(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetColorSpaceConvert()\n");
    BYTE uc, csc ;
	#ifdef AME_SA7160
    ...
    if( csc == B_CSC_RGB2YUV )
    {
        ...
        {
            F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "ITU709 ");

            if(p_sys_cfg->o_input_ite6603.bInputVideoMode & F_MODE_16_235)
            {
                F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, " 16-235\n");
            ...
            {
                F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, " 0-255\n");
        ...
        {
            F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "ITU601 ");
#if defined(AME_PL330B) || defined(AME_PL330A)
             F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, " 16-235 means 1:1,  0-255 means 1: 0.89\n");
			//always 1:1
			if(1)
#else
            if(p_sys_cfg->o_input_ite6603.bInputVideoMode & F_MODE_16_235)
    ...
    {
        F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "CSC = YUV2RGB ");
        if(p_sys_cfg->o_input_ite6603.bInputVideoMode & F_MODE_ITU709)
        {
            F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "ITU709 ");
...
void
SetDVIVideoOutput(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetDVIVideoOutput()\n");
...
void
SetNewInfoVideoOutput(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    /*
    BYTE db1,db2,db3 ;
    ...
    do {
        ...
        F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetNewInfoVideoOutput(): %02X %02X %02X\n",(int)db1,(int)db2,(int)db3));
    } while ( (db1 != db2)||(db2!=db3)) ;
    */
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetNewInfoVideoOutput()\n");
...
void
SetCAT6023VideoOutputFormat(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE bOutputMapping, BYTE bOutputType, BYTE bOutputColorMode)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetCAT6023VideoOutputFormat()\n");
	#ifdef AME_SA7160
	...
	BYTE uc ;
    SetVideoMute(p_Device, ON) ;
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "%02X %02X %02X\n",(int)bOutputMapping,(int)bOutputType,(int)bOutputColorMode);
    ...
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "write %02X %02X\n",(int)REG_RX_PG_CTRL2,(int)uc);
    HDMIRX_WriteI2C_Byte( p_Device, REG_RX_PG_CTRL2, uc) ;
...
void
ResetAudio(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "ResetAudio()\n");
...
void
SetHWMuteCTRL(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE AndMask, BYTE OrMask)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetHWMuteCTRL()\n");
    BYTE uc ;
...
void
SetVideoMute(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BOOL bMute)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetVideoMute()\n");
	#ifdef AME_SA7160
...
void
SetAudioMute(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BOOL bMute)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "SetAudioMute()\n");
    if( bMute )
    {
...
BYTE
getCAT6023AudioStatus(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023AudioStatus()\n");
...
BOOL
getCAT6023AudioChannelStatus(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE ucIEC60958ChStat[])
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "getCAT6023AudioChannelStatus()\n");
...
void
setCAT6023_HBROutput(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BOOL HBR_SPDIF)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "setCAT6023_HBROutput()\n");
    BYTE uc ;
    Switch_HDMIRX_Bank(p_Device, 0) ;
    uc = HDMIRX_ReadI2C_Byte( p_Device, REG_RX_HWAMP_CTRL) ;
...
void
setCAT6023_SPDIFOutput(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "setCAT6023_SPDIFOutput()\n");
    BYTE uc ;
    Switch_HDMIRX_Bank(p_Device, 0) ;
    uc = HDMIRX_ReadI2C_Byte( p_Device, REG_RX_FS_SET) ;
    uc &= ~0x30 ;
...
void
setCAT6023_I2SOutput(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE src_enable)
{
    //F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "setCAT6023_I2SOutput()\n");
    Switch_HDMIRX_Bank(p_Device, 0) ;
...
void EnableMuteProcessTimer(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) 
{ 	
	#ifdef AME_SA7160
...
void DisableMuteProcessTimer(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) 
{ 
	#ifdef AME_SA7160
...
void StartAutoMuteOffTimer(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) 
{ 
	#ifdef AME_SA7160
...
void EndAutoMuteOffTimer(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) 
{ 
	#ifdef AME_SA7160
...
void
DumpCat6023Reg(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device)
{
    int i,j ;
    BYTE ucData ;
    ...
    for( j = 0 ; j < 16 ; j++ )
    {
        F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, " %02X",(int)j);
        if( (j == 3)||(j==7)||(j==11))
        {
            F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "  ");
        }
    ...
    {
        F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "[%3X]  ",(int)i);
        for( j = 0 ; j < 16 ; j++ )
        {
            ucData = HDMIRX_ReadI2C_Byte( p_Device, (BYTE)((i+j)&0xFF) );
            F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, " %02X",(int)ucData);
            if( (j == 3)||(j==7)||(j==11))
            {
                F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, " -");
            }
...
int GetITE6604_1001(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, int dotclk_6604, int vtotal, int htotal)
{
	unsigned int audion, audiocts, audiocd_fs, i, dotclock;
	unsigned char colordepth, temp;

	if(!((vtotal == 1125 && (((htotal <= 2200 + 4) && (htotal >= 2200 - 4) ) || ((htotal <= 2750 + 4) && (htotal >= 2750 - 4) ))) ||		//1920*1080, 60p, 30p, 24p
		 (((htotal <= 2200 + 4) && (htotal >= 2200 - 4) ) &&	(vtotal == 562 || vtotal == 563)) ||		//1920*1080i60
		 (vtotal == 750 && (((htotal <= 1650 + 4) && (htotal >= 1650 - 4) ) || ((htotal <= 3300 + 4) && (htotal >= 3300 - 4) ) || ((htotal <= 4125 + 4) && (htotal >= 4125 - 4) ) )) ||		//1280*720, 60p, 30p, 24p
 	     (((htotal <= 858*2 + 4) && (htotal >= 858*2 - 4) ) && (vtotal == 262 || vtotal == 263)) ||		//720*480i60
 	     (((htotal <= 858 + 4) && (htotal >= 858 - 4) ) && (vtotal == 262 || vtotal == 263)) ||			//720*480i60
	     (((htotal <= 800 + 4) && (htotal >= 800 - 4) ) && vtotal == 525) ||							//640*480p60
	     (((htotal <= 858 + 4) && (htotal >= 858 - 4) ) && vtotal == 525)))								//720*480p60
	{
		F966EAAB748564259849CBD3F3D6C48A7( KERN_INFO, "no 1001 item\n");		
		HDMIRX_WriteI2C_Byte(p_Device, 0x78, 0xc1);
		return 0;
	}
    temp = HDMIRX_ReadI2C_Byte(p_Device, 0x10);
	if((temp & 0x10) == 0)		//not HDMI mode
	{
		HDMIRX_WriteI2C_Byte(p_Device, 0x78, 0xc1);
		return 0;
	}
	...
	if(colordepth == 5)	//30bit, TMDS clock = 1.25*pixel clock
	{
	    dotclock = (dotclock*4)/5;
	}
	if(colordepth == 6)	//36bit, TMDS clock = 1.5*pixel clock
	{
		dotclock = (dotclock*2)/3;
	}
	if(colordepth == 7)	//48bit, TMDS clock = 2.0*pixel clock
	{
		dotclock = (dotclock)/2;
	}
	...
	dotclock = dotclock*((dotclk_6604+(dotclock/2))/dotclock);

	i = 0;
	while(1)
	{
		audion = CEA861DotClock2[i];
		if(dotclock >= (audion-(audion/2000))&&dotclock <= (audion+(audion/2000)))
			break;
		i++;
		if(i >= 10)
		{
	...
	//test if the dot clock need to multiply 2 or not
	if((i & 1) == 0)	//even index number at CEA861DotClock2[i]
		return 1;		//is 59.95 frame rate
	return 0;
}
