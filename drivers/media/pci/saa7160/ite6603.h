...
#define REG_RX_F7F93DF8A9ECE49c1884C75ADC18648B7 0x0F
...
void Switch_HDMIRX_Bank(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE x);//   HDMIRX_WriteI2C_Byte(p_Device, 0x0f,(x)&1)
...
*/
void SetHWMuteClrMode(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device);// { SetHWMuteCTRL(p_Device, (~B_HW_AUDMUTE_CLR_MODE),(B_HW_AUDMUTE_CLR_MODE)) ;}
void SetHWMuteClr(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device);// { SetHWMuteCTRL(p_Device, (~B_HW_MUTE_CLR),(B_HW_MUTE_CLR)) ; }
void ClearHWMuteClr(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device);// { SetHWMuteCTRL(p_Device, (~B_HW_MUTE_CLR),0) ; }
void SetALLMute(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device);// SetMUTE(B_VDO_MUTE_DISABLE,(B_VDO_MUTE_DISABLE|B_TRI_ALL))


BYTE Get_IT6603_Initialization_Status(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device);
void Check_HDMInterrupt(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device);

BYTE HDMIRX_ReadI2C_Byte(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE RegAddr);
BOOL HDMIRX_WriteI2C_Byte(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE RegAddr,BYTE d);
BOOL HDMIRX_ReadI2C_ByteN(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE RegAddr,BYTE *pData,int N);
BOOL HDMIRX_WriteI2C_ByteN(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE RegAddr,BYTE *pData,int N);

BOOL bGetSyncInfo(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
BOOL CheckHDMIRX(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void SelectHDMIPort(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE ucPort);
BYTE GetCurrentHDMIPort(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device);

//void DumpHDMIRX() ;

void Interrupt_Handler(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void Timer_Handler(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void Video_Handler(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;

//void HWReset_HDMIRX() ;
void SWReset_HDMIRX(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void Terminator_Reset(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void Terminator_Off(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void Terminator_On(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;

void Check_RDROM(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void RDROM_Reset(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void SetDefaultRegisterValue(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;

void LoadCustomizeDefaultSetting(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void SetupAudio(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;

//BOOL ReadRXIntPin() ;

void ClearIntFlags(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE flag) ;
void ClearHDCPIntFlags(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
BOOL IsSCDT(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
BOOL CheckPlg5VPwr(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;

//BOOL CheckHDCPFail() ;
void SetMUTE(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE AndMask, BYTE OrMask) ;
void SetMCLKInOUt(BYTE MCLKSelect) ;
void SetIntMask1(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE AndMask,BYTE OrMask) ;
void SetIntMask2(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE AndMask,BYTE OrMask) ;
void SetIntMask3(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE AndMask,BYTE OrMask) ;
void SetIntMask4(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE AndMask,BYTE OrMask) ;
void SetGeneralPktType(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE type) ;
BOOL IsCAT6023HDMIMode(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void EnableAudio(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;


void RXINT_5V_PwrOn(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void RXINT_5V_PwrOff(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void RXINT_SCDT_On(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void RXINT_SCDT_Off(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void RXINT_RXCKON(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void RXINT_VideoMode_Chg(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void RXINT_HDMIMode_Chg(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void RXINT_AVMute_Set(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void RXINT_AVMute_Clear(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void RXINT_SetNewAVIInfo(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void RXINT_ResetAudio(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void RXINT_ResetHDCP(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
//void TimerServiceISR() ;
void VideoTimerHandler(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void AudioTimerHandler(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void MuteProcessTimerHandler(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;

void AssignVideoTimerTimeout(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, USHORT TimeOut) ;
void ResetVideoTimerTimeout(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void SwitchVideoState(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, Video_State_Type state) ;

void AssignAudioTimerTimeout(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, USHORT TimeOut) ;
void ResetAudioTimerTimeout(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void SwitchAudioState(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, Audio_State_Type state) ;
...
void DumpSyncInfo(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, VTiming *pVTiming) ;
...
void SetVideoInputFormatWithoutInfoFrame(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE bInMode) ;
void SetColorimetryByMode(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device/* PSYNC_INFO pSyncInfo */) ;
void SetVideoInputFormatWithInfoFrame(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
BOOL SetColorimetryByInfoFrame(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void SetColorSpaceConvert(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;

//void HDCP_Reset() ;
void SetDVIVideoOutput(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void SetNewInfoVideoOutput(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void SetCAT6023VideoOutputFormat(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE bOutputMapping, BYTE bOutputType, BYTE bOutputColorMode);
void ResetAudio(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device) ;
void SetHWMuteCTRL(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE AndMask, BYTE OrMask) ;
void SetAudioMute(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BOOL bMute) ;
void SetVideoMute(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BOOL bMute) ;
...
void InitCAT6023(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device);
...
BOOL GetAVIInfoFrame(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE *pData);
BOOL GetAudioInfoFrame(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE *pData);
BOOL GetMPEGInfoFrame(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE *pData);
BOOL GetVENDORSPECInfoFrame(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE *pData);
BOOL GetACPPacket(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE *pData);



void getCAT6023Regs(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE *pData);
BYTE getCAT6023OutputColorMode(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device);
BYTE getCAT6023OutputColorDepth(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device);
...
BYTE getCAT6023AudioStatus(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device);
BOOL getCAT6023AudioChannelStatus(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE ucIEC60958ChStat[]);
void setCAT6023_HBROutput(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BOOL HBR_SPDIF);
void setCAT6023_SPDIFOutput(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device);
void setCAT6023_I2SOutput(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device, BYTE src_enable);
void DumpCat6023Reg(F42A18AF66EFF459eA332CA253FFF8A65 * p_Device);
